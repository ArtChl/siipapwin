...
public class NotaDeCreditoPorDevolucionForm extends AbstractControl{
	...
	private JComponent buildGridPanel(){
		...
		final String[] cols=new String[]{"Id","Cantidad","Artículo","Descripcion","Precio U","Importe","Cortes","Maniobras","Neto"};
	...
	public static void show() {
		...
		SXAbstractDialog dialog=new SXAbstractDialog("Prueba"){
			...
			protected JComponent buildHeader() {
				return new HeaderPanel("Nota de Credito por Devolución"," Mantenimiento y consulta de Notas por devoluciones ");
			}
