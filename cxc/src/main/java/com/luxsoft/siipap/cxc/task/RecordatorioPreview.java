...
public class RecordatorioPreview extends SXAbstractDialog {
	...
	private URL url;
	private String text;
	private final ClienteCredito cliente;
	
	public RecordatorioPreview(final URL url,final ClienteCredito c) {
		super("Recordatorio de pago");
		this.url=url;
		this.cliente=c;
	}
	
	public RecordatorioPreview(final String text,final ClienteCredito c) {
		super("Recordatorio de pago");
		this.text=text;
		this.cliente=c;
