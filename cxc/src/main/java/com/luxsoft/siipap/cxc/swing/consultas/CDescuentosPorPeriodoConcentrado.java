...
public class CDescuentosPorPeriodoConcentrado extends AbstractView{
	...
	content.add(new HeaderPanel("Descuentos Por Periodo Concentrado","Consulta Descuentos Por Periodo Concentrado"),BorderLayout.NORTH);
	...
	private EventList createEventList(){
		...
		final TextComponentMatcherEditor sucEditor=new TextComponentMatcherEditor(sucursal,sucFilterator);
		final FilterList sucList=new FilterList(periodoList,sucEditor);
	...
	public static void main(String[] args) {
		...
		final CDescuentosPorPeriodoConcentrado e=new CDescuentosPorPeriodoConcentrado();
		SXAbstractDialog dialog=new SXAbstractDialog("DESCUENTO POR PERIODO CONCENTRADO"){
