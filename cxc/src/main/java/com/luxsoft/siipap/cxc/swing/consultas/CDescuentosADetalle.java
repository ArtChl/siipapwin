...
public class CDescuentosADetalle extends AbstractView{
	...
	content.add(new HeaderPanel("Descuentos a Detalle","Consulta Descuentos a Detalle"),BorderLayout.NORTH);
	...
	private EventList createEventList(){
		...
		final FilterList sucursalList=new FilterList(claveList,descripcionEditor);
	...
	private class TF implements TableFormat<Map<String, Object>>{
		...
		String cols[]={"LINEA","CLAVE","DESCRIPCION","NOMBRE","SERIE","SUCURSAL","PERIODO","TIPO_VENTA","IMP_P_LIST"
	...
	private List loadData(){
		String sql=SQLUtils.loadSQLQueryFromResource("sql/CDescuentosADetalle.sql");
	...
	public static void main(String[] args) {
		...
		final CDescuentosADetalle e=new CDescuentosADetalle();
		SXAbstractDialog dialog=new SXAbstractDialog("DESCUENTO A DETALLE"){
