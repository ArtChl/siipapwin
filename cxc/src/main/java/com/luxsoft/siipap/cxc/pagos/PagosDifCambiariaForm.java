 ...
 *
 */
public class PagosDifCambiariaForm extends SXAbstractDialog{
	
	private JXTable grid;
	private EventList<Venta> ventas;
	private EventSelectionModel<Venta> selectionModel;

	public PagosDifCambiariaForm(final Collection<Venta> ventas) {
		super("Generación de pagos por diferencia cambiaria");
	...
	protected JComponent buildHeader() {
		return new HeaderPanel(
				"Pago de diferencia cambiaria ",
				"Lista de ventas que califican para pago ",
