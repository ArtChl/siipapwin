...
public class ComsSinAnalizarReport extends SXAbstractDialog {
...
//	articulo=Binder.createArticulosBinding(articuloModel);
	...
	protected JComponent buildHeader() {
		...
		return new HeaderPanel("Coms Sin Analizar General","Reporte De coms Sin Analizar");
	}
...
//		builder.add(sucursales,cc.xyw(3, 5, 3));
    ...
    private void execute(){
		...
		final String rep="/Com_SinAnalizar_General.jasper";
    ...
    public static void run(){
    	ComsSinAnalizarReport inv=new ComsSinAnalizarReport();
    	inv.open();
    }
