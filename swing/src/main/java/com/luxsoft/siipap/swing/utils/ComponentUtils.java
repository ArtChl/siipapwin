...
public final class ComponentUtils {
    ...
    public static void decorateSpecialFocusTraversal(Container c){
    	c.setFocusTraversalKeys(KeyboardFocusManager.FORWARD_TRAVERSAL_KEYS, getNextFoculsKeys());
    	c.setFocusTraversalKeys(KeyboardFocusManager.BACKWARD_TRAVERSAL_KEYS, getPreviousFocusKeys());
